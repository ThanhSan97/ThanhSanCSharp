...
{   
    ...
    {   
        ...
        static void Main(string[] args)
        {
            ...
            System.Console.WriteLine(hcn1.tinhChuVi());
            System.Console.WriteLine(hcn1.tinhDienTich());
            HinhTron ht1 = new HinhTron(2.5);
            System.Console.WriteLine(ht1.tinhChuVi());
            System.Console.WriteLine(ht1.tinhDienTich());
        }
    }
}